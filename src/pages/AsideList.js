...
function AsideList({curPage, onMenuClick, stackParam, stackColor, stackAsideColor}) {
	...
	return (
		<Common.ContentAside stackAsideColor={stackAsideColor}>
			...
			<nav>
				<Common.MenuContainer onClick={goToMenu}>
					...
					<Common.MenuContent selected={selected === 4} value={4} stackColor={stackColor}>Summary & Contact</Common.MenuContent>
